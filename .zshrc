...
export PATH=${JAVA_HOME}/bin:/usr/local/bin:/usr/local/sbin:~/bin:$(brew --prefix coreutils)/libexec/gnubin:$PATH
export RBENV_ROOT=$HOME/.rbenv

#export LSCOLORS=gxfxcxdxbxegedabagacad
#export LS_COLORS="no=00;31:fi=00;32:di=00;36:ln=00;31:ex=00;31"

# Mac標準のターミナルだと下記LS_COLORSがイイ(でないとディレクトリの色とか見づらい)
#export LS_COLORS="di=00;36:ln=00;35"

# iTerm2だと下記LS_COLORSが良い感じ(Linux標準のLS_COLORSと同じ)
